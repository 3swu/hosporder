...
<head>
	...
	<!--<style >
		*{/*通配符*/
		...
		<script >
			function onDepartment(doctor)
			{
			    sessionStorage.doctorid = doctor.id;
			    window.open("test/testList.html");
			}
				  ...
				  success:function(data){
					  ...
					  for(var i in dataObj){
						  $(".departmentList").append(
							  '<li id="' + dataObj[i]['doctorid'] + '" onclick="onDepartment(this)">\n' +
							  "<h5>\n" +
                              dataObj[i]['name'] +
